import { AvatarGroup, Avatar, Box, Typography, ImageList, ImageListItem, ListItemAvatar, List, ListItem, ListItemText, Divider } from '@mui/material'
  ...
  return (
    <Box flex={1} p={2} sx={{display: { xs: "none", sm: "block" }}}>
      <Box position="fixed" width={300}>
        ...
        <ImageList cols={3} gap={2} rowHeight={100}>
          <ImageListItem>
            <img
